...
public static final String RS_API_VERSION_STR = "1.12.1";
...
public native float z(); public native float3 z(float z); }
    ...
    @Namespace("rs") @NoOffset public static class motion_callback extends rs_motion_callback {
        ...
        public motion_callback(@ByVal std::function<void(motion_data)> on_event) { super((Pointer)null); allocate(on_event); }
        private native void allocate(@ByVal std::function<void(motion_data)> on_event);
    ...
    @Namespace("rs") @NoOffset public static class timestamp_callback extends rs_timestamp_callback {
        ...
        public timestamp_callback(@ByVal std::function<void(timestamp_data)> on_event) { super((Pointer)null); allocate(on_event); }
        private native void allocate(@ByVal std::function<void(timestamp_data)> on_event);
    ...
    @Namespace("rs") @NoOffset public static class frame extends Pointer {
        ...
        public frame(@ByVal frame other) { super((Pointer)null); allocate(other); }
        private native void allocate(@ByVal frame other);
    ...
    @Namespace("rs") @NoOffset public static class frame_callback extends rs_frame_callback {
        ...
        public frame_callback(@ByVal std::function<void(frame)> on_frame) { super((Pointer)null); allocate(on_frame); }
        private native void allocate(@ByVal std::function<void(frame)> on_frame);
    ...
    @Namespace("rs") public static class device extends Pointer {
         ...
         *  @return            the framerate of the stream, in frames per second */
        public native void set_frame_callback(@Cast("rs::stream") int stream, @ByVal std::function<void(frame)> frame_handler);
         ...
         *  @return                       the framerate of the stream, in frames per second */
        public native void enable_motion_tracking(@ByVal std::function<void(motion_data)> motion_handler, @ByVal std::function<void(timestamp_data)> timestamp_handler);

        /** sets the callback for motion module event. provided callback will be called the instant new motion event is available. 
         *  @param [in] stream             the stream 
         *  @param [in] motion_handler     frame callback to be invoke on every new motion event
         *  @return                       the framerate of the stream, in frames per second */
        public native void enable_motion_tracking(@ByVal std::function<void(motion_data)> motion_handler);
    ...
    @Namespace("rs") @NoOffset public static class log_callback extends rs_log_callback {
        ...
        public log_callback(@ByVal std::function<void(log_severity,const char*)> on_event) { super((Pointer)null); allocate(on_event); }
        private native void allocate(@ByVal std::function<void(log_severity,const char*)> on_event);
    ...
    @Namespace("rs") public static native void log_to_callback(@Cast("rs::log_severity") int min_severity, @ByVal std::function<void(log_severity,const char*)> callback);
